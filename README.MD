...
Masked face detection on self constructed dataset using KNN.
...
● Tried different classifiers but we only use KNN but you can use different classifiers if you want for better accuracy.
